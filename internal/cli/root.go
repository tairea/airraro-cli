...
func newRootCmd(flags *rootFlags) *cobra.Command {
	rootCmd := &cobra.Command{
		Use:   "airraro-pp-cli",
		Short: `Airraro CLI — Live Cook Islands flight fares and the full Air Rarotonga route network, agent-native with offline search.`,
		Long: `Airraro CLI — Live Cook Islands flight fares and the full Air Rarotonga route network, agent-native with offline search.
...
Health check: run 'airraro-pp-cli doctor' to verify auth and connectivity.
See README.md or the bundled SKILL.md for recipes.`,
		SilenceUsage: true,
		Version:      version,
	}
	rootCmd.SetVersionTemplate("airraro-pp-cli {{ .Version }}\n")
	...
	rootCmd.PersistentFlags().StringVar(&flags.profileName, "profile", "", "Apply values from a saved profile (see 'airraro-pp-cli profile list')")
