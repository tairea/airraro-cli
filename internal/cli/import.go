...
but do not stop the import.`,
  ...
  airraro-pp-cli import <resource> --input data.jsonl

  # Dry-run to preview without sending
  airraro-pp-cli import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | airraro-pp-cli import <resource> --input -`,
